 ...
 * @LastEditTime: 2021-01-30 16:42:11
--> 
<template>
    <div class="user-management">
        ...
        <el-form :inline="true" ref="form" size="small" :model="listQuery" class="demo-form-inline">
            <el-form-item label="部门名称">
                <el-input v-model="listQuery.deptName" placeholder="填写部门名称"></el-input>
            </el-form-item>
            <el-form-item>
...
<script>
import { getDeptList, getDeptInfo, delDept, isForbidDept } from '@/api/manage';
...
export default {
    ...
    methods:{
        ...
        async handleForbid(row){
            ...
            this.$confirm(`此操作将${str}该部门, 是否继续?`, '提示',{
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then( () => {
        ...
        // 跳转至设备管理
        navTo(row){
            this.$router.push({path:'/sys/facility',query:{id:row.deptId}})
        },
        //当前页码发生变化时
